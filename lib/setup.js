...
database.query("create table adminPosts(id varchar(30) not null primary key, postTitle varchar(50) not null , postContent varchar(800) not null, postLink varchar(120), postLinkName varchar(40), adminUsername varchar(40))");
